...
function mash_choice() {  // New function called mash_choice that doesn't take any parameters 
    ...
    var mash = ['French villa', 'sex dungeon', 'beach house', 'nudist colony'];  // The array of choices to pick from 
